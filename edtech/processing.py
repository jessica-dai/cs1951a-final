...
database = "/Users/rebeccazuo/Desktop/DataScienceFinal/edtech/all_data.db"
...
for line in read_data:
    ...
    if(line[6] == "2"):
        ...
        # if (urban == 1 and region == 1):
		#  	combined = 1
	    # if(urban == 1 and region == 2):
		#     combined = 2
	    # if(urban == 1 and region == 3):
		#     combined = 3
	    # if(urban == 1 and region == 4):
		#     combined = 4
	    # if(urban == 2 and region == 1):
		#     combined = 5
	    # if(urban == 2 and region == 2):
		#     combined = 6
	    # if(urban == 2 and region == 3):
		#     combined = 7
	    # if(urban == 2 and region == 4):
		#     combined = 8
	    # if(urban == 3 and region == 1):
		#     combined = 9
	    # if(urban == 3 and region == 2):
		#     combined = 10
	    # if(urban == 3 and region == 3):
		#     combined = 11
	    # if(urban == 3 and region == 4):
		#     combined = 12
	    # if(urban == 4 and region == 1):
		#     combined = 13
	    # if(urban == 4 and region == 2):
		#     combined = 14
	    # if(urban == 4 and region == 3):
		#     combined = 15
	    # if(urban == 4 and region == 4):
		#     combined = 16
